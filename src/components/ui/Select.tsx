    ...
    <div className={`mb-4 ${className}`}>
      ...
      <div className="relative">
        <select
          ...
          className="w-full appearance-none px-3 py-2.5 pr-10 text-sm rounded-lg shadow-sm cursor-pointer transition-all duration-200 bg-surface border border-theme text-primary"
          onFocus={(e) => {
